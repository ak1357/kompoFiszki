...
namespace App\Components\Sheet;
use App\Interfaces;

interface SheetInterface extends Interfaces\iCollection, Interfaces\iUser
{
	
   public function getSheetWords ();
	
}


class main implements SheetInterface
{
